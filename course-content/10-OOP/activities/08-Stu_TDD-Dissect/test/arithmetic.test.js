...
describe("Arithmetic", () => {
  ...
  //   it("should return an object containing a 'number' property is a value of a string as value if instantiated with a string", () => {
  //     const obj = new Arithmetic("I am a string");
  //     expect(typeof obj.number).toEqual("string");
  //   });

  //   it("should return an object containing a 'number' property is a value of a number as value if instantiated with a number", () => {
  //     const obj = new Arithmetic(13);
  //     expect(typeof obj.number).toEqual('number');
  //   });
  // });
