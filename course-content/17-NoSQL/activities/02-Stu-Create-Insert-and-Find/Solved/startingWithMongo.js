...
db.students.insert({name: 'Farley', row:3, os:'Mac', hobbies:["Reading", "Surfing", "Dancing", 'Coding'] })

db.students.insert({name: 'Asher', row:1, os:'Mac', hobbies:['Coding', 'Music', 'Dogs', 'Working Out'] })

db.students.insert({name: 'Sage', row:1, os:'Windows', hobbies:['Coding', 'Reading'] })

db.students.insert({name: 'Jerome', row:3, os:'Mac', hobbies:['Coding', 'Hiking', 'MCU', 'Dabbing'] })
...
db.students.find({name:'Sage'})


db.students.find({$or:[{name:'Sage'},{name:'Asher'}]})
